...
<t:particularTemplate>
    ...
    <jsp:body>    
        ...
        <div class="container">
            ...
            <div class="row">
                    <div class="form-group">
                        <center><button class="btn btn-primary pull-right" type="submit" id="btnGuardar" onclick="insertaEmpleado()">Guardar</button></center>
                        <button class="btn btn-primary pull-right" onclick="consultaEmpleados()" id="btnLimpiar">Regresar</button>
                    </div>
            </div>
                ...
                <div class="modal-dialog" id="myModal12">
                    <div class="modal-content" id="myModal2">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal" onclick="consultaEmpleados()">Cerrar</button>
                        </div>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal-dialog -->
            </div><!-- /.modal -->
...
<script src="<c:url value="/static/js/app/Usuarios/empleado.js" />" rel="text/javascript"></script>