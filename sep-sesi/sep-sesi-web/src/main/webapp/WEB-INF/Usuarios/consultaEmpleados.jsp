        ...
        <div class="container">
            ...
            <div class="row">
                <center>
                    ...
                    <button id="nuevoEmpleado" class="btn btn-primary" style="margin-left: 30px;">
                        <span class="glyphicon glyphicon-plus"></span>
                        Nuevo empleado
                    </button>
                    <button id="gafete" class="btn btn-primary credencial" type="submit" style="margin-left: 30px;">Imprimir gafete</button>
                    <button id="credencial" class="btn btn-primary credencial" type="submit" style="margin-left: 30px;">Imprimir credencial</button>
                </center>
            </div><br><br><br>
            <div class="table-responsive">
                <table id="resultadosResumenTable"></table>
            </div>
            <div class="modal fade" id="ModalEmpleado" data-backdrop="static" data-keyboard="false" style="overflow-y: scroll;">
                        ...
                        <div class="modal-body">
                            <div class="container">
                                ...
                                <form role="form" enctype="multipart/form-data" target="dummyframe" id="formCarga">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6" id="urDivModal">
                                                ...
                                                <select class="form-control"  id="urModal" name="urModal" onClick="asignaUR(), obtenerArea()">
                                                    <option>SELECCIONA </option>
                                                </select>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6" id="areaDiv">
                                                <label class="control-label" for="area">Subárea:</label>

                                                <select class="form-control"  id="areaId" name="areaId" >
                                                    <option>SELECCIONA </option>
                                                </select>
                                                <span id="errorarea" class="help-block"></span>
                                            </div>
                                            <div class="col-md-6" id="puestoDiv">
                                                <label class="control-label" for="puesto">Puesto*</label>
                                                <input class="form-control" id="puesto" name="puesto" placeholder="Puesto" type="text" value="" onkeyup="this.value = this.value.toUpperCase()" maxlength="59">
                                    ...
                                    <div class="form-group">     
                                        <div class="row">
                                            <div class="col-md-6" id="emergenciaDiv">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6" id="sangreDiv">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <button class="btn btn-primary pull-right" type="submit" id="btnGuardar" onclick="insertaEmpleado()">Guardar</button>
            ...
            <div class="modal fade" id="ModalGafetes" data-backdrop="static" data-keyboard="false" style="overflow-y: scroll;">
                <div class="modal-dialog" id="myModal1">
                    <div class="modal-content" id="myModal2">
                        <div class="modal-header" id="myModal3">
                            <h4 class="modal-title">SESI</h4>
                        ...
                        <div class="modal-body">
                            <div class="container">
                                ...
                                <div class="col-md-12" align="center">
                                    <h4>¿Los gafetes serán impresos en una impresora PVC?</h4>
                                </div>

                                <div class="row">
                                    <center>
                                        <button class="btn btn-primary" type="button" onclick="enviaPVC()" >Si</button>
                                        <button class="btn btn-default" type="button" onclick="enviaCredencial()" >No</button>
                                    </center>
                                </div>
...
<script src="<c:url value="/static/js/app/Usuarios/consultaEmpleado.js" />" rel="text/javascript"></script>		
