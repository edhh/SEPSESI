<%-- 
    Document   : entradaSalidaEquipos
    Created on : 7/09/2021, 11:22:39 AM
...
<t:particularTemplate>
    <jsp:attribute name="paginaTitulo">
        Búsqueda de entrada/salida de equipos
    </jsp:attribute>
    ...
    <jsp:body>    
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h4>Búsqueda de entrada/salida de equipos</h4>
                    <hr class="red">
                </div>
            </div>
            <!--</div>-->
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6" id="serieDiv">
                        <label class="control-label" for="serie">Número de serie:</label>
                        <input class="form-control" id="serie" placeholder="Número de serie" name="serie" type="text" value=""/>
                        <span id="errorSerie" class="help-block"></span>
                    </div>
                </div>
            </div>
...
<script src="<c:url value="/static/js/app/Consulta/entradaSalidaEquipos.js" />" rel="text/javascript"></script>
