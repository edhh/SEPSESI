  ...
  var dialogs = {
    ...
    removeInputStylingAndMessage: function($input, conf) {
      ...
      if (typeof conf.inlineErrorMessageCallback === 'function') {
        ...
        $parentContainer.find('span.form-text-error').removeClass('form-text-error');
        $parentContainer
          .find('.' + conf.inlineErrorMessageClass.replace(' ','.'))
          .remove();
      }
    ...
    setInlineMessage: function ($input, errorMsg, conf) {
      ...
      if (custom) {
        ...
        $message = $parent.find('.' + conf.inlineErrorMessageClass.replace(' ','.') + '.help-block');
        if ($message.length === 0) {
          $parent.find('span.form-text').addClass('form-text-error');
          $message = $('<small></small>').addClass('help-block').addClass(conf.inlineErrorMessageClass);
  ...
  $.formUtils = $.extend($.formUtils || {}, {
    ...
    defaultConfig: function () {
      return {
        ...
        errorElementClass: 'form-control-error', // Class that will be put on elements which value is invalid
        ...
        inlineErrorMessageClass: 'form-text form-text-error', // class name of div containing error messages when validation fails
        ...
        decimalSeparator: '.',
        inputParentClassOnError: 'form-control-error', // twitter-bootstrap default class name
    ...
    LANG: {
      ...
      lengthBadStart: 'Tu respuesta debe incluir entre ',
      lengthBadEnd: ' caracteres',
      lengthTooLongStart: 'Tu respuesta debe de ser menor a ',
      lengthTooShortStart: 'Tu respuesta debe de ser mayor a ',
