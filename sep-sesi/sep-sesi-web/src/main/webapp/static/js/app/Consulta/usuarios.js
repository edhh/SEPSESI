...
$("#buscar").click(function () {
    ...
    if (validaDatos()) {
        ...
        $('#loader').modal('toggle');
        $.ajax({
            url: baseURI + "/mvc/consulta/consultaUsuarios",
            type: 'GET',
        ...
        if (validaDatos()) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.length > 0) {
                    if (tipoPersona === '3') {
                        console.log('reporteVisitante');
                        window.document.location.href = baseURI + '/mvc/jasper/repUsuariosVisitante?idUr=' + idUR + '&curp=' + $('#curp').val() + '&idInmueble=' + idINMUEBLE
                                + '&idTipoPersona=' + $('#rol').val();
                    } else {
                        console.log('reporteUsuario');
                        window.document.location.href = baseURI + '/mvc/jasper/repUsuarios?idUr=' + idUR + '&curp=' + $('#curp').val() + '&idInmueble=' + idINMUEBLE
                                + '&idTipoPersona=' + $('#rol').val();
                    }
                    } else {
