...
$("#limpiar").click(function () {
    ...
    $("#errorSerie").text('');
    $("#errorSerie").hide();
    $("#serieDiv").removeClass("has-error");
...
$("#buscar").click(function () {
    ...
    if (validaDatos()) {
        ...
        param["hasta"] = fecha2;
        param["curp"] = curp;
        param["numSerie"] = serie;
        $('#loader').modal('toggle');
        $.ajax({
            url: baseURI + "/mvc/consulta/consultaEquipos",
            type: 'GET',
        ...
        if (validaDatos()) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.length > 0) {
                        if (tipoPersona === '3') {
                            window.document.location.href = baseURI + '/mvc/jasper/repEquiposVis?entradaSalida=' + idOperacion + '&tipoPersona=' + idTipoPersona + '&idUr=' + idUR
                                    + '&idInmueble=' + idINMUEBLE + '&fecha1=' + desde + '&fecha2=' + hasta + '&curp=' + curp + '&serie=' + serie;
                        } else {
                            window.document.location.href = baseURI + '/mvc/jasper/repEquipos?entradaSalida=' + idOperacion + '&tipoPersona=' + idTipoPersona + '&idUr=' + idUR
                                    + '&idInmueble=' + idINMUEBLE + '&fecha1=' + desde + '&fecha2=' + hasta + '&curp=' + curp + '&serie=' + serie;
                        }
                    } else {
