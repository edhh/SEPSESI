...
public class ControlAccesoController {
    ...
    /**
     * Método que permite el registro de Empleados, Proveedores y Visitantes  mediante el datos encriptados
     * @param operacionVO
     * @return
     * @throws Exception 
     */
    ...
    public ResponseEntity<?> registrarEntrada(@RequestBody OperacionVO operacionVO, HttpServletRequest request ) throws Exception {
        ...
        try{
            ...
            System.out.println("ERROR_02 - La sesión expiro ");
            return new ResponseEntity<String>("La sesión expiro, por favor autentificarse de nuevo", HttpStatus.REQUEST_TIMEOUT);
    ...
    /**
     * Método que permite el registro de Empleados y Proveedores.
     * @param operacionVO
     * @return
     * @throws Exception 
     */
    ...
    public ResponseEntity<?> registrarEntradaPersona(@RequestBody OperacionVO operacionVO ) throws Exception {
        ...
        try{
            //System.out.println("Paso 1: Consulta información persona... " + new Date());
            persona = controlAccesoServicio.obtenerInformacion(idPersona); 
            if( persona != null ){
                if(persona.getEstatus() == 1){ 
                    //System.out.println("Paso 2: Solicita registro de operación - idPersona: " +  persona.getIdPersona() + " fecha:" +new Date());
                    Optional<Long> idOperacion  =  controlAccesoServicio.registrarEntrada(operacionVO);
    ...
    /**
     * Método que permite el registro de visitantes.
     * @param operacionVO
     * @return
     * @throws Exception 
     */
